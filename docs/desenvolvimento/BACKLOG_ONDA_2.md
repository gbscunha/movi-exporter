...
| 15 | 🟡 | S | ⬜ | **Export: Busca/filtro na lista de veículos** — 330 veículos em scroll vertical é inviável. Adicionar `CTkEntry` de busca acima do scroll (filtra por nome/placa em runtime). Bônus: "Selecionar todos visíveis", contador "X/Y selecionados". | QA manual v1.1.0 |
