...
| 46 | 🟢 | XS | ✅ | ~~Atualizar GitHub Actions para Node.js 24~~ — **Resolvido na Fase 01 da Onda 2**. Bumps: `checkout@v4→v5`, `setup-python@v5→v6`, `upload/download-artifact@v4→v5`, `softprops/action-gh-release@v1→v2`. Próxima execução do CI/build vai usar Node 24. | Aviso CI release v1.1.0 |
