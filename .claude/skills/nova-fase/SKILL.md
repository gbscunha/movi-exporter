Implemente a próxima fase pendente do `docs/desenvolvimento/PLANO_REFACTOR.md`.

Siga este ciclo:

1. **CONSULTAR** — Leia o PLANO_REFACTOR.md e identifique a próxima fase com status ⬜ Todo.
...
5. **ATUALIZAR** — Marque a fase como ✅ na tabela do PLANO_REFACTOR.md e commite a atualização.
